...
const page = () => {
  return (
    <div className="p-5">
      <div
        className="flex flex-col-reverse gap-2 justify-center items-center h-[100vh] md:flex-row md:justify-around md:items-center"
        id="Home"
      >
        <div>
          <TypeWriter />
      ...
      <div
        className="mb-[4rem] md:flex md:flex-row-reverse md:justify-between md:items-center"
        id="About"
      >
        <div className="md:w-1/2 grid gap-[1.3rem]">
          ...
          <div className="flex md:hidden justify-center">
            <Image src="/img/aboutR.png" width={300} height={300} alt="" />
          </div>
          ...
          <div className="flex gap-2 my-3">
            <Link href="/">
              <Image src="/img/github.png" width={50} height={50} alt="" />
            </Link>
            <Link href="/">
              <Image src="/img/instagram.png" width={50} height={50} alt="" />
            </Link>
          </div>
        </div>
        <div className="hidden md:block">
          <Image src="/img/aboutR.png" width={600} height={600} alt="" />
        </div>
      </div>

      <div
        className="my-[4rem] bg-sky-700 p-2 rounded-lg shadow-xl "
        id="Skill"
      >
        <h1 className="text-4xl md:text-6xl font-bold mb-4 bg-[rgb(215,181,30)] w-fit p-3 text-center ">
          Skills
        </h1>
      ...
      <div className="grid gap-4" id="Project">
